...
class EcmpEdit extends Component {
  ...
  constructor(props) {
    super(props);
    this.fid = _.uniqueId('ecmpEditForm_');
  ...
  isDirty = () => {
    const data = this.props.ecmp;
    return (this.state.ecmpDataObj.enabled !== data.enabled || this.state.ecmpDataObj.resilientHash !== data.resilientHash ||
    this.state.ecmpDataObj.hashSrcIp !== data.hashSrcIp || this.state.ecmpDataObj.hashSrcPort !== data.hashSrcPort || this.state.ecmpDataObj.hashDstIp !== data.hashDstIp || this.state.ecmpDataObj.hashDstPort !== data.hashDstPort);
  };

  _onChange = (e) => {
    const fieldName = e.target.getAttribute('id');
    const ecmpDataObj = { ...this.state.ecmpDataObj, [fieldName]: e.target.checked ? 'enabled' : 'disabled' };
